> New here? Start with [README.md](README.md) for an overview of what's in this repo and how to
> consume the published packages, image, and app. This file is the project's running development
> log — a rolling, mostly-chronological account of design decisions, dead ends, and fixes, kept
> for the detail it preserves rather than for onboarding.

# CDSi Immunization Engine — Development Log
